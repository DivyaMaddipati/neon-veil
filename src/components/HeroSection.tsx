      ...
      <div className="container mx-auto relative z-10 flex flex-col items-center text-center">
        ...
        {!isAuthenticated && (
          <button 
            ...
            className="hero-animate opacity-0 bg-[#6c43ff] text-white font-medium py-3 px-8 md:px-10 rounded-md text-lg md:text-xl mb-12 md:mb-20 relative overflow-hidden group mt-6 md:mt-8 hover:shadow-[0_0_15px_rgba(108,67,255,0.8)] animate-pulse-glow"
          >
